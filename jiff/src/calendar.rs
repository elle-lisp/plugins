...
pub extern "C" fn prim_date_start_of_month(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/start-of-month") { Ok(d) => d, Err(e) => return e };
...
pub extern "C" fn prim_date_end_of_month(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/end-of-month") { Ok(d) => d, Err(e) => return e };
...
pub extern "C" fn prim_date_start_of_year(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/start-of-year") { Ok(d) => d, Err(e) => return e };
...
pub extern "C" fn prim_date_end_of_year(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/end-of-year") { Ok(d) => d, Err(e) => return e };
...
pub extern "C" fn prim_date_next_weekday(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/next-weekday") { Ok(d) => d, Err(e) => return e };
    let kw = match require_keyword(a.arg(args, nargs, 1), "date/next-weekday") { Ok(k) => k, Err(e) => return e };
...
pub extern "C" fn prim_date_prev_weekday(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let d = match extract_date(a.arg(args, nargs, 0), "date/prev-weekday") { Ok(d) => d, Err(e) => return e };
    let kw = match require_keyword(a.arg(args, nargs, 1), "date/prev-weekday") { Ok(k) => k, Err(e) => return e };
...
pub extern "C" fn prim_tz_valid(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let name = match require_string(a.arg(args, nargs, 0), "tz-valid?") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_tz_fixed(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let offset_secs = match require_int(a.arg(args, nargs, 0), "tz-fixed") { Ok(n) => n as i32, Err(e) => return e };
...
pub extern "C" fn prim_temporal_series(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let start = match require_jiff(a.arg(args, nargs, 0), "temporal/series") { Ok(jv) => jv.clone(), Err(e) => return e };
    let step = match require_variant!(a.arg(args, nargs, 1), Span, "temporal/series", "span") { Ok(s) => *s, Err(e) => return e };
    let count = match require_int(a.arg(args, nargs, 2), "temporal/series") { Ok(n) => n as usize, Err(e) => return e };
