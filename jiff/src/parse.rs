...
pub extern "C" fn prim_date_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "date/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_time_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "time/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_datetime_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "datetime/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_timestamp_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "timestamp/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_zoned_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "zoned/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_span_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "span/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_signed_duration_parse(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let s = match require_string(unsafe { a.arg(args, nargs, 0) }, "signed-duration/parse") { Ok(s) => s, Err(e) => return e };
...
pub extern "C" fn prim_temporal_parse_with(args: *const ElleValue, nargs: usize) -> ElleResult {
    let a = crate::api();
    let fmt = match require_string(unsafe { a.arg(args, nargs, 0) }, "temporal/parse-with") { Ok(s) => s, Err(e) => return e };
    let input = match require_string(unsafe { a.arg(args, nargs, 1) }, "temporal/parse-with") { Ok(s) => s, Err(e) => return e };
